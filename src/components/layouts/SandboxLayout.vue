<template>
  ...
  <div class="content-wrapper">
            ...
            <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
              ...
              <div class="w-100 order-1 order-lg-0 d-lg-flex offcanvas-body">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="https://sumsel.bps.go.id" target="_blank">Official Web</a>
                  </li>
                </ul>
              </div>
              <div class="w-100 order-3 order-lg-2 d-lg-flex offcanvas-body text-end">
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-4 gy-lg-0">
          <div class="col-lg-8 align-self-center">
            <div class="blog-filter filter">
              <ul>
                <li><a class="active" href="./monograph.html">Monograph</a></li>
                <li><a href="./kemiskinan.html">Kemiskinan</a></li>
                <li><a href="#">Stunting</a></li>
                <li><a href="#">UMKM</a></li>
                <li><a href="#">Peta Tematik</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <section class="wrapper bg-light">
      <div class="container pb-2 pb-md-2 pt-8 pt-md-6">
        <div class="row">
          <div class="col-12 col-lg-6">
            <div id="section_tempat_ibadah">
              <h2>Fasilitas Ibadah</h2>
              <table class="table table-bordered table-responsive table-sm" style="border: #00000034;">
                <thead>
                  <tr>
            ...
            <div id="section_faskes">
              <h2>Fasilitas Kesehatan</h2>
              <table class="table table-bordered  table-sm" style="border: #00000034;">
                <thead>
                  <tr>
                    <th class="text-center">No</th>
                    <th scope="col">Fasilitas</th>
                ...
                <tbody style="border: #00000034;">
                  ...
                  <tr>
                    <th scope="row" class="text-center">6</th>
                    <td>Poliklinik/balai pengobatan</td>
                    <td class="text-center">1</td>
                  </tr>
                  <tr>
                    <th scope="row" class="text-center">7</th>
                    <td>Rumah bersalin</td>
                    <td class="text-center">1</td>
                  </tr>
                  <tr>
                    <th scope="row" class="text-center">8</th>
                  ...
                  <tr>
                    ...
                    <td>Polindes (pondok bersalin desa)</td>
                    <td class="text-center">1</td>
                  </tr>
                  <tr>
          ...
          <div class="col-12 col-lg-6">
            <div id="section_penduduk">
              <h2>Profile Penduduk</h2>
              <table class="table table-bordered  table-sm" style="border: #00000034;">
                <thead>
                  <tr>
                    <th class="text-center">No</th>
    ...
    <section class="wrapper bg-light" id="section_luas_wilayah">
      <div class="container pb-2 pb-md-3 pt-md-10">
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          ...
          <!--/column -->
          <div class="col-lg-6">
            <div class="swiper-container text-center mb-6" data-margin="30" data-dots="true" data-items-xl="2"
      ...
      <div class="row gy-6 gy-lg-0">
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            ...
            <nav class="nav social social-white">
              <a href="https://www.facebook.com/people/Bps-Provinsi-Sumatera-Selatan/100015484759318/"
                target="_blank"><i class="uil uil-facebook-f"></i></a>
              <a href="https://www.instagram.com/bpssumsel/?hl=en" target="_blank"><i class="uil uil-instagram"></i></a>
              <a href="https://www.youtube.com/channel/UC-9WQN-5cNTVTGDF8Rkiu6A" target="_blank"><i
                  class="uil uil-youtube"></i></a>
            </nav>
            <!-- /.social -->
        ...
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            ...
            <address class="pe-xl-15 pe-xxl-17">Jl. Kapten Anwar Sastro No 1694 Palembang, Sumatera Selatan 30129
            </address>
            <a href="mailto:#">bps1600@bps.go.id</a><br /> Telp (0711) 351665, 318456
          </div>
          <!-- /.widget -->
        </div>
        <!-- /column -->
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            ...
            <ul class="list-unstyled  mb-0">
              <li><a href="https://sumsel.bps.go.id" target="_blank">Official BPS SUMSEL</a></li>
              <li><a href="https://pstdigital.bpssumsel.com" target="_blank">Konsultasi Online</a></li>
              <li><a href="https://sdgsforsumsel.bpssumsel.com" target="_blank">SDG's For Sumsel</a></li>
              <li><a href="https://zi.bpssumsel.com" target="_blank">Zona Integritas</a></li>
                ...
                <form action="#" method="post" id="mc-embedded-subscribe-form2" name="mc-embedded-subscribe-form"
                  ...
                  <div id="mc_embed_signup_scroll2">
                    <div class="mc-field-group input-group form-floating">
                      ...
                      <input type="button" value="Join" name="subscribe" id="mc-embedded-subscribe2"
